#!/usr/bin/env python3
"""
this module contains unittests for a client
"""
import unittest
...
class TestGithubOrgClient(unittest.TestCase):
    """unittest to test GithubOrgClient """
    ...
    def test_org(self, mock_getJson, org_name, resource):
        """this method should test if GithubOrgClient.org returns the
        correct output"""
        GithubOrgClient(org_name).org
        mock_getJson.assert_called_once_with(resource)

    def test_public_repos_url(self):
        """this method tests if the public repository url
